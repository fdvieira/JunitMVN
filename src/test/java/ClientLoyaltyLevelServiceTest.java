...
public class ClientLoyaltyLevelServiceTest {
  ...
  public void oldClientShouldHaveGoldLevelStatus() {
    //given
    LocalDate joinDate = LocalDate.now().minusDays(12201);
  ...
  public void newClientShouldNotHaveGoldLevelStatus() {
    //given
    LocalDate joinDate1 = LocalDate.now().minusDays(99);

    //when
    boolean isGoldMember = clientLoyaltyLevelService.isGoldMember(joinDate1);
